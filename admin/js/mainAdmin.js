...
function resetForm() {
    ...
    var elements = document.querySelectorAll(".sp-thongbao");
...
function addProduct() {
    ...
    && kiemTraDoDai(sp.backCamera, "#tbBackCameraSP", 6, 60, "Thông số camera sau khoảng từ 6 đến 30 kí tự")

    // 5. Kiểm tra Camera trước
    isValid &= kiemTraRong(sp.frontCamera, "#tbFrontCameraSP", "Camera trước không được đê trống")
    && kiemTraDoDai(sp.frontCamera, "#tbFrontCameraSP", 6, 60, "Thông số camera trước khoảng từ 6 đến 30 kí tự")
